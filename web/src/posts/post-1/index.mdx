...
2. enhance user interactions with blockchains
	...
	<blockquote class="twitter-tweet"><p lang="en" dir="ltr">Also imagine in the future wallet just detects on which network you have funds, you send, all the gas/tx fee management happens under the hood</p>&mdash; stani.eth 👻 =(⬤_⬤)= 👻 (@StaniKulechov) <a href="https://twitter.com/StaniKulechov/status/1366761244712194050?ref_src=twsrc%5Etfw">March 2, 2021</a></blockquote> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script>
